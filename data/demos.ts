...
export const PALETTES = {
  ...
  'ivory-navy':      { mode: 'light', bg: '#f5f0e8', surface: '#fffdf8', ink: '#0d1b2a', muted: '#6f6a58', primary: '#0d1b2a', accent: '#c9a96e', onPrimary: '#f5f0e8' },
  ...
  'midnight-gold':   { mode: 'dark', bg: '#0d1b2a', surface: '#14263c', ink: '#f5f0e8', muted: '#9aa0b8', primary: '#c9a96e', accent: '#6fb3c0', onPrimary: '#0d1b2a' },
